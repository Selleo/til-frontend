defmodule TilWeb.PostControllerTest do
  ...
  describe "GET /api/posts" do
    ...
    test "returns posts with proper like count", %{conn: conn} do
      ...
      insert(:like, user_id: first_user.id, post_id: second_post.id)
  ...
  describe "GET /api/posts/:id" do
    ...
    test "returns particular post with proper likes count", %{conn: conn} do
      ...
      insert(:like, user_id: first_user.id, post_id: post.id)
      insert(:like, user_id: second_user.id, post_id: post.id)
